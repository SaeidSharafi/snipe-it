...
<div class="form-group{{ $errors->has('min_amt') ? ' has-error' : '' }}">
    ...
    <div class="col-md-7{{  (\App\Helpers\Helper::checkIfRequired($item, 'min_amt')) ? ' required' : '' }}">
       <div class="col-md-2" style="padding-left:0px">
            <input class="form-control" type="text" name="min_amt" id="min_amt" aria-label="min_amt" value="{{ old('min_amt', $item->min_amt) }}" />
        </div>
