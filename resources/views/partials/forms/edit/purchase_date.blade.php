<!-- Purchase Date -->
<div class="form-group {{ $errors->has('purchase_date') ? ' has-error' : '' }}" id="datepicker-app">
   ...
   <div class="input-group col-md-3">
       <x-date-picker name="purchase_date"
                      id="purchase_date"
                      initial-value="{{ old('purchase_date', ($item->purchase_date) ? $item->purchase_date->format('Y-m-d') : '') }}"
