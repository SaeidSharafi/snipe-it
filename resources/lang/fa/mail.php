...
return array(
    ...
    'asset' => 'اموال:',
    'asset_name' => 'نام اموال',
    'asset_requested' => 'درخواست اموال شد',
    'asset_tag' => 'Asset Tag',
    ...
    'click_on_the_link_asset' => 'لطفا روی لینک زیر کلیک کنید تا تأیید کنید که اموال را دریافت کرده اید.',
    ...
    'min_QTY' => 'حداقل تعداد',
    'name' => 'نام',
    'new_item_checked' => 'یک آیتم جدید تحویل شما شده است، جزئیات:',
    'password' => 'کلمه عبور:',
    'password_reset' => 'تنظیم مجدد رمز عبور',

    'read_the_terms' => 'لطفا شرایط استفاده زیر را بخوانید.',
    'read_the_terms_and_click' => 'لطفا شرایط استفاده زیر را مطالعه کنید و روی لینک زیر کلیک کنید تا تأیید کنید که شما شرایط استفاده را می خوانید و موافقت کرده اید و اموال را دریافت کرده اید.',
    ...
    'test_mail_text' => 'این آزمون از سیستم مدیریت اموال Snipe-IT است. اگر شما این کار را کردید، ایمیل کار می کند :)',
