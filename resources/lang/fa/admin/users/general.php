...
return array(
    ...
    'assets_user'       => 'اموال محول شده به :name',
    ...
    'current_assets'    => 'اموال اکنون  برای این کاربر بیرون کشیده شد',
    'clone'             => 'کلون کاربر',
    'contact_user'      => 'تماس با :name',
    'edit'              => 'ویرایش کاربر',
    'filetype_info'     => 'پسوند های مجاز:png, gif, jpg, jpeg, doc, docx, pdf, txt, zip,Rar',
    'history_user'      => 'تاریخچه برای :name',
	'info'				=> 'اطلاعات',
    ...
    'software_user'     => 'برنامه های تحویل شده به :name',
    'send_email_help'   => 'You must provide an email address for this user to send them credentials. Emailing credentials can only be done on user creation. Passwords are stored in a one-way hash and cannot be retrieved once saved.',
    'view_user'         => 'نمایش کاربر :name',
    'usercsv'           => 'فایل CSV',
