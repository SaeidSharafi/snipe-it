...
return array(
    ...
    'alerts_enabled'			=> 'ایمیل هشدار فعال شود',
    ...
    'audit_interval_help'       => 'اگر شما ملزم هستید که به طور منظم از اموال های خود حسابرسی کنید، فاصله را در ماه وارد کنید.',
    'audit_warning_days'        => 'آستانه هشدار بازرسی',
    'audit_warning_days_help'   => 'چند روز پیش باید به شما هشدار می دهیم هنگامی که اموال برای حسابرسی مورد نیاز است؟',
    'auto_increment_assets'		=> 'تولید شناسه اموال (افزایش خودکار)',
    'auto_increment_prefix'		=> 'پیشوند (اختیاری)',
    'auto_incrementing_help'    => 'فعال کردن شناسه اموال (افزایش خودکار) اول به این مجموعه',
    ...
    'default_eula_help_text'	=> 'همچنین می توانید  EULA های سفارشی به دسته های خاص اموال مرتبط کنید.',
    'display_asset_name'        => 'نمایش نام حساب',
    'display_checkout_date'     => 'نمایش تاریخ تحویل به همکار',
...
',
    ...
    'full_multiple_companies_support_help_text' => 'محدود کردن کاربران (از جمله مدیران) اختصاص داده شده به شرکت ها برای اموال های شرکت خود را.',
    ...
    'require_accept_signature_help_text'      => 'فعال کردن این ویژگی، کاربران را مجبور به فیزیکی در پذیرش یک اموال می کند.',
    'left'        => 'چپ',
    'right'        => 'راست',
    'top'        => 'بالا',
    'bottom'        => 'پایین',
    ...
    'zerofill_count'        => 'طول برچسب اموال، از جمله zerofill',
